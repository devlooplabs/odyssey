...
export interface ApiPlanPaymentOptionPlanPaymentOption
  extends Struct.CollectionTypeSchema {
  collectionName: 'plan_payment_options';
  info: {
    singularName: 'plan-payment-option';
    pluralName: 'plan-payment-options';
    displayName: 'Plan Payment Option';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiSerieEpisodeSerieEpisode
  extends Struct.CollectionTypeSchema {
...
export interface ApiSerieSeasonSerieSeason extends Struct.CollectionTypeSchema {
