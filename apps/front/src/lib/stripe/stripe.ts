...
export class StripeClient {
  ...
  private async createSubscriptionSession(
    ...
    return await this.client.checkout.sessions.create({
      ...
      success_url: `${process.env.NEXT_PUBLIC_SITE_URL}/payment/checkout?status=success`,
      cancel_url: `${process.env.NEXT_PUBLIC_SITE_URL}/payment/checkout?status=failure`,
